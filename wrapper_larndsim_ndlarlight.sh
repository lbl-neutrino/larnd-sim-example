...
source /pscratch/sd/m/madan12/DUNE/Nesap_2026/larnd-sim-example/setup.inc.sh

# Activate the existing virtual environment
source /pscratch/sd/m/madan12/DUNE/Nesap_2026/larnd-sim-example/larnd-sim.cuda12.venv/bin/activate

# Set up simulation start time
sim_start_time=$(date '+%Y-%m-%d_%H:%M:%S')

# Read the file list into an array
#mapfile -t file_names < /pscratch/sd/m/madan12/DUNE/for_SC25/larnd-sim-example/DUNE_4filelist_ndlar_test.txt
mapfile -t file_names < /pscratch/sd/m/madan12/DUNE/Nesap_2026/larnd-sim-example/MiniProdN5p1_NDComplex_FHC_100.txt
